...
export const StarRating: React.FC<StarRatingProps> = ({ maxRating = 5, color = "#fcc419", size = 48, className = "", messages = [], onSetRating }) => {
...
export const Star: React.FC<StarProps> = ({ onRate, full, onHoverIn, onHoverOut, color, size }) => {
